  ...
  switch (request.type) {
    ...
    case "lab": {
      ...
      return {
        title: zh ? "船坞" : "Lab",
        description: zh
          ? "十七个交互实验：WebGL shader、物理模拟、流场、算法可视化，以及等待、阅读、来源与降级。"
          : "Seventeen interactive experiments — WebGL, physics, flow fields, plus waiting, reading, sources, and degradation.",
