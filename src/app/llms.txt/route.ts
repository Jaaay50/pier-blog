...
export function GET() {
  ...
  const lines = [
    ...
    "- Lab (船坞): seventeen interactive experiments, including a cloud-sea train shader, waiting, streaming reading, source independence, and what remains after effects are off",
