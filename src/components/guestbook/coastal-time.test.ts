...
import { coastalTimeForDate, coastalTimeFromHour, getBeijingHour } from "./coastal-time";
...
describe("coastal time", () => {
  ...
  it("uses Asia/Shanghai rather than the host timezone", () => {
    expect(getBeijingHour(new Date("2026-09-11T00:00:00.000Z"))).toBe(8);
