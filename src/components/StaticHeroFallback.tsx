    ...
    return (
      <div className="absolute inset-0" aria-hidden>
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 60% at 50% 35%, rgba(106, 155, 204, 0.14) 0%, rgba(138, 180, 221, 0.07) 45%, transparent 75%)",
          }}
        />
        ...
        <div
          ...
          style={{
            backgroundImage:
              ...
              "radial-gradient(1px 1px at 58% 48%, #8ab4dd 50%, transparent 100%)," +
