...
- Loops: the same names with `.webm` (640×360 VP9, muted). Day is ~59s with one-bottle and several-bottle beats; dawn/dusk/night are ~69s. Idle waves are ping-ponged so the loop returns to the first frame.
